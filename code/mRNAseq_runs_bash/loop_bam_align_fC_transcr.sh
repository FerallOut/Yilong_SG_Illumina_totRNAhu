...
do
    ...
    -o /data/processing1/bioinfo_core/requests/FANCI_RNA_seq_4stresses/analysis_bam_fC_transcr/ \
    -v -j 20 --DAG --emailAddress balan@ie-freiburg.mpg.de --smtpServer mail.ie-freiburg.mpg.de \
    --emailSender balan@ie-freiburg.mpg.de --featureCountsOption '-t transcript' \
