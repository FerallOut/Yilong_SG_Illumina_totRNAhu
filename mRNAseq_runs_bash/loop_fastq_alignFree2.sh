...
for k in $(find /data/processing1/bioinfo_core/requests/FANCI_RNA_seq_4stresses/sampleSheets/new_ss -iname 'sgRNA_*' -printf '%P\n')
do
    ...
    --filterGTF='-v pseudogene' --sampleSheet ./sampleSheets/new_ss/${k} --rMats hg38
done
